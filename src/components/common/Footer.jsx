          ...
          <div className='lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3'>
            ...
            <div className="w-[48%] lg:w-[30%] mb-7 lg:pl-0">
              ...
              <div >
                ...
                <Link to={"/help-center"} className="text-[14px] cursor-pointer hover:text-richblack-50 transition-all duration-200 mt-2"> Help Center</Link>
              </div>
            </div>
            ...
            <div className=" lg w-[30%] mb-7 flex lg:flex-wrap flex-col justify-betwen justify-start lg:pl-0">
              ...
              <div>
                <h1 className="text-richblack-50 font-semibold text-[16px] lg:mt-7">Community</h1>
                <div>
                  {
                    Community.map((ele,i)=>{
                      return(
...
>
         ...
         <div className="flex flex-col lg:flex-row items-center justify-between w-11/12 max-w-maxContent text-richblack-400 mx-auto  pb-14 pt-9 text-sm">
                  ...
                  <div className="text-center lg:mt-0 mt-5">Made with ❤️ Sourav Sharma © 2024 Studynotion</div>
        </div>
    </div>
  )
}
